...
For the [NaNoGenMo 2021](https://github.com/NaNoGenMo/2021) commitment, Luther Blissett was taking the original Text **"On Anarchism"** by Noam Chomsky from »[The Anachist Library](https://theanarchistlibrary.org/library/noam-chomsky-on-anarchism).
